...
namespace EntityFrameworkLibrary
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_GetTotalIncomes(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_GetTotalIncomes", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}

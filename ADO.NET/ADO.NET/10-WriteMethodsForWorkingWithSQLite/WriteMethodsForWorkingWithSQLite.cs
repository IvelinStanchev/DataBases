...
namespace _10_WriteMethodsForWorkingWithSQLite
{
    class WriteMethodsForWorkingWithSQLite
    {
        static void Main()
        {
            ...
            SQLiteConnection dbConnection = new SQLiteConnection("Data Source=BookStore.db;Version=3;");
            dbConnection.Open();
            using (dbConnection)
            {
